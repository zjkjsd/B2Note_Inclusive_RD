...
The method is sound and a prototype exists on the \texttt{claude/bbbar-tuning-diagnostics} branch of the analysis repository; it is not
part of the analysis at the pinned commit and requires a fit with an interior
minimum.  Whether that is achievable by relaxing the bounds, requires
...
posed in Sec.~\ref{sec:bbbar:degeneracy}}
