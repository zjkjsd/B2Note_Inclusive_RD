...
\texttt{scripts/bbbar\_eigen\_systematics.py}, which postdates the commit
pinned by this note; it requires a fit with an interior minimum.  Whether that is achievable by relaxing the bounds, requires
