...
but it postdates the commit pinned by this note and has never been run on real
ntuples.  Everything above is therefore an inference from the metadata of
eight stored fits.  No conclusion about merging decay families should be drawn
until the scan has been run and its output cross-checked}
